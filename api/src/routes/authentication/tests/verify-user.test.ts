...
describe('test authentication routes', () => {
	...
	describe('test verifyIdentity route', () => {
		...
		beforeEach(() => {
			...
			updateUserVerificationSpy = spyOn(ssiService, 'updateUserVerification');
			addUserVCSpy = spyOn(ssiService, 'addUserVC');
		});
		...
		it('should not verify since different userId in request', async () => {
			...
			const getUserSpy = spyOn(ssiService, 'getUser').and.returnValue(subject);
			const req: any = {
